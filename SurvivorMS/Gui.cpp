...
gui::ProgressBar::ProgressBar(float _x, float _y, float _width, float _height, float charSizeMultip, int maxValue, sf::Color innerColor, sf::VideoMode& vm, sf::Font* font, bool withTxt) {
